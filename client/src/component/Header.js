...
export const Header = () => {
  ...
  async  function getAllProduct(){
    ...
    //console.log("53",jwtDecode(localStorage.getItem("token")).accountType)
    return (
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to="/filter">All Filter</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/notfound">New Arrivals</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/notfound">Featured Products</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`/search/${'Smartphone'}`}>Electronics</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="#">Fashions</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/notfound">Accessories</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/notfound">Appliances</Link>
                            </li>
                        </ul>
                    </div>
                </div>
